...
class CustomFrameHandlerTest {
    ...
    void handleFrameLogicWhenConnectGatewayThenDoItSuccessfully() {
        ...
        StompHeaders headersStop = new StompHeaders();
        headersStop.setDestination(STOP_GATEWAY_ENDPOINT);

        customFrameHandler.handleFrameLogic(headersStop, stringNetworkId);
