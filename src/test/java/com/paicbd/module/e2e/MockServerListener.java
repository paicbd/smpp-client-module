...
public class MockServerListener implements SessionStateListener, ServerMessageReceiverListener {
    ...
    public MockServerListener(Exception forcedException, boolean isEmptyShortMessage) {
        this.forcedException = forcedException;
        this.isEmptyShortMessage = isEmptyShortMessage;
    }
    ...
    private void scheduleDeliveryReceipt(SubmitSm submitSm, String messageId) {
        this.scheduler.schedule(() ->
                this.sendReactiveDeliverSm(getRandomSessionForClient(), messageId, 1, submitSm, this.isEmptyShortMessage)
    ...
    public Mono<Void> sendReactiveDeliverSm(SMPPServerSession serverSession, String messageId, int tlv, SubmitSm submitSm, boolean isEmptyShortMessage) {
                ...
                .flatMap(sm -> {
                    ...
                    try {
                        ...
                        serverSession.deliverShortMessage(
                                ...
                                (isEmptyShortMessage) ? new byte[0] : delRec.toString().getBytes(),
